...
import TablePaginator from '../common/TablePaginator'; // ← ajusta la ruta según tu proyecto
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                {columns.map(({ key, label, field, thClass }) => (
                  <th
                    ...
                    className={`px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase
                      tracking-wider cursor-pointer hover:bg-gray-100 transition whitespace-nowrap
                      select-none ${thClass ?? ''}`}
                  >
        ...
        {/* ── TablePaginator — fuera del overflow-x-auto ── */}
        <TablePaginator
          page={page}
      ...
      {/* ── Modal Tracking WMS — fuera del div con overflow-hidden ── */}
      {trackingPedido && (
        <WmsTrackingModal
